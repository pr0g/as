...
constexpr index_t vec_t<T, n>::size()
{
    return n;
}

template<typename T, index_t n>
constexpr T& vec_t<T, n>::operator[](index_t i) &
{
    return elem[i];
}

template<typename T, index_t n>
constexpr const T& vec_t<T, n>::operator[](index_t i) const&
{
    return elem[i];
}
...
template<typename T>
constexpr index_t vec2_base_t<T>::size()
{
    return 2;
}
...
template<typename T>
constexpr index_t vec3_base_t<T>::size()
{
    return 3;
}
...
template<typename T>
constexpr vec3_base_t<T>::vec3_base_t(T xyz_) : x(xyz_), y(xyz_), z(xyz_)
{
}

template<typename T>
constexpr vec3_base_t<T>::vec3_base_t(const vec_t<T, 2>& xy_, T z_)
    : x(xy_.x), y(xy_.y), z(z_)
{
}

template<typename T>
constexpr vec3_base_t<T>::vec3_base_t(T x_, T y_, T z_) : x(x_), y(y_), z(z_)
{
}

template<typename T>
constexpr vec_t<T, 2> vec3_base_t<T>::xy() const
{
    return {x, y};
}
...
template<typename T>
constexpr vec_t<T, 3>::vec_t(T xyz_) : internal::vec3_base_t<T>(xyz_)
{
}

template<typename T>
constexpr vec_t<T, 3>::vec_t(const vec_t<T, 2>& xy_, T z_)
    : internal::vec3_base_t<T>(xy_, z_)
{
}

template<typename T>
constexpr vec_t<T, 3>::vec_t(T x_, T y_, T z_)
...
template<typename T>
constexpr index_t vec4_base_t<T>::size()
{
    return 4;
}

template<typename T>
T& vec4_base_t<T>::operator[](index_t i) &
{
    return this->*elem[i];
}

template<typename T>
const T& vec4_base_t<T>::operator[](index_t i) const&
{
    return this->*elem[i];
}

template<typename T>
const T vec4_base_t<T>::operator[](index_t i) &&
{
    return this->*elem[i];
}

template<typename T>
constexpr vec4_base_t<T>::vec4_base_t(T xyzw_)
    : x(xyzw_), y(xyzw_), z(xyzw_), w(xyzw_)
{
}

template<typename T>
constexpr vec4_base_t<T>::vec4_base_t(const vec_t<T, 3>& xyz_, T w_)
    : x(xyz_.x), y(xyz_.y), z(xyz_.z), w(w_)
{
}

template<typename T>
constexpr vec4_base_t<T>::vec4_base_t(const vec_t<T, 2>& xy_, T z_, T w_)
    : x(xy_.x), y(xy_.y), z(z_), w(w_)
{
}

template<typename T>
constexpr vec4_base_t<T>::vec4_base_t(
...
template<typename T>
constexpr vec4_base_t<T>::vec4_base_t(T x_, T y_, T z_, T w_)
    : x(x_), y(y_), z(z_), w(w_)
{
}

template<typename T>
constexpr vec_t<T, 2> vec4_base_t<T>::xy() const
{
    return {x, y};
}

template<typename T>
constexpr vec_t<T, 2> vec4_base_t<T>::zw() const
{
    return {z, w};
}

template<typename T>
constexpr vec_t<T, 3> vec4_base_t<T>::xyz() const
{
    return {x, y, z};
}
...
template<typename T>
constexpr vec_t<T, 4>::vec_t(T xyzw_) : internal::vec4_base_t<T>(xyzw_)
{
}

template<typename T>
constexpr vec_t<T, 4>::vec_t(const vec_t<T, 3>& xyz_, T w_)
    : internal::vec4_base_t<T>(xyz_, w_)
{
}

template<typename T>
constexpr vec_t<T, 4>::vec_t(const vec_t<T, 2>& xy_, T z_, T w_)
    : internal::vec4_base_t<T>(xy_, z_, w_)
{
}

template<typename T>
constexpr vec_t<T, 4>::vec_t(const vec_t<T, 2>& xy_, const vec_t<T, 2>& zw)
    : internal::vec4_base_t<T>(xy_, zw)
{
}

template<typename T>
constexpr vec_t<T, 4>::vec_t(T x_, T y_, T z_, T w_)
