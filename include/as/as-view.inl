...
AS_API inline mat4 perspective_vk_rh(
  const real fovy, const real aspect, const real n, const real f)
{
  return as::mat_mul(perspective_gl_rh(fovy, aspect, n, f), vulkan_clip);
}

AS_API inline mat4 perspective_vk_lh(
  const real fovy, const real aspect, const real n, const real f)
{
...
AS_API inline mat4 ortho_vk_rh(real l, real r, real b, real t, real n, real f)
{
  return as::mat_mul(ortho_gl_rh(l, r, b, t, n, f), vulkan_clip);
}

AS_API inline mat4 ortho_vk_lh(real l, real r, real b, real t, real n, real f)
{
