...
TEST_CASE("vec2_initialization", "[as_vec]")
{
  ...
  {
    vec2_t vec2{};
    CHECK_THAT(arr(0.0_r, 0.0_r), make_elements_sub(vec2, 2));
  }
  ...
  {
    vec2_t vec2{1.0_r, 2.0_r};
    CHECK_THAT(arr(1.0_r, 2.0_r), make_elements_sub(vec2, 2));
  }

  // direct initialization - single argument (braces)
  {
    vec2_t vec2{5.0_r};
    CHECK_THAT(arr(5.0_r, 5.0_r), make_elements_sub(vec2, 2));
  }

  // direct initialization (parens)
  {
    vec2_t vec2(5.0_r, 10.0_r);
    CHECK_THAT(arr(5.0_r, 10.0_r), make_elements_sub(vec2, 2));
  }
  ...
  // direct initialization - single argument (parens)
  {
    vec2_t vec2;
    vec2 = vec2_t(6.0_r);
    CHECK_THAT(arr(6.0_r, 6.0_r), make_elements_sub(vec2, 2));
  }

  // direct/copy initialization (braces)
  {
    vec2_t vec2 = vec2_t{3.0_r, 4.0_r};
    CHECK_THAT(arr(3.0_r, 4.0_r), make_elements_sub(vec2, 2));
  }
  ...
  // direct/copy initialization - single argument (braces)
  {
    ...
    CHECK_THAT(arr(123.0_r, 123.0_r), make_elements_sub(vec2, 2));
  }
  ...
  // assignment initialization - single argument (braces)
  {
    vec2_t vec2;
    vec2 = vec2_t{75.0_r};
    CHECK_THAT(arr(75.0_r, 75.0_r), make_elements_sub(vec2, 2));
  }
...
TEST_CASE("vec3_initialization", "[as_vec]")
{
  ...
  {
    vec3_t vec3{};
    CHECK_THAT(arr(0.0_r, 0.0_r, 0.0_r), make_elements_sub(vec3, 3));
  }
  ...
  // direct initialization (braces)
  {
    ...
    CHECK_THAT(arr(1.0_r, 2.0_r, 3.0_r), make_elements_sub(vec3, 3));
  }

  // direct initialization (parens)
  {
    vec3_t vec3(5.0_r, 10.0_r, 15.0_r);
    CHECK_THAT(arr(5.0_r, 10.0_r, 15.0_r), make_elements_sub(vec3, 3));
  }

  // direct/copy initialization (braces)
  {
    vec3_t vec3 = vec3_t{1.0_r, 2.0_r, 3.0_r};
    CHECK_THAT(arr(1.0_r, 2.0_r, 3.0_r), make_elements_sub(vec3, 3));
  }

  // direct/copy initialization (parens)
  {
    vec3_t vec3 = vec3_t(3.0_r, 4.0_r, 5.0_r);
    CHECK_THAT(arr(3.0_r, 4.0_r, 5.0_r), make_elements_sub(vec3, 3));
  }

  // direct/copy initialization - single argument (braces)
  {
    vec3_t vec3 = vec3_t{50.0_r};
    CHECK_THAT(arr(50.0_r, 50.0_r, 50.0_r), make_elements_sub(vec3, 3));
  }
  ...
  {
    vec3_t vec3 = vec3_t{vec2_t{1.0_r, 2.0_r}, 3.0_r};
    CHECK_THAT(arr(1.0_r, 2.0_r, 3.0_r), make_elements_sub(vec3, 3));
  }

  // direct/copy initialization - double argument (parens)
  {
    vec2_t vec2 = vec2_t(1.0_r, 2.0_r);
    vec3_t vec3 = vec3_t(vec2, 3.0_r);
    CHECK_THAT(arr(1.0_r, 2.0_r, 3.0_r), make_elements_sub(vec3, 3));
  }
...
TEST_CASE("vec4_initialization", "[as_vec]")
{
  ...
  {
    vec4_t vec4{};
    CHECK_THAT(arr(0.0_r, 0.0_r, 0.0_r, 0.0_r), make_elements_sub(vec4, 4));
  }
  ...
  // direct initialization (braces)
  {
    ...
    CHECK_THAT(arr(1.0_r, 2.0_r, 3.0_r, 4.0_r), make_elements_sub(vec4, 4));
  }
  ...
  // direct/copy initialization (braces)
  {
    vec4_t vec4 = vec4_t{3.0_r, 4.0_r, 5.0_r, 6.0_r};
    CHECK_THAT(arr(3.0_r, 4.0_r, 5.0_r, 6.0_r), make_elements_sub(vec4, 4));
  }
  ...
  // direct/copy initialization - double argument (braces)
  {
    vec4_t vec4 = vec4_t{vec3_t{1.0_r, 2.0_r, 3.0_r}, 4.0_r};
    CHECK_THAT(arr(1.0_r, 2.0_r, 3.0_r, 4.0_r), make_elements_sub(vec4, 4));
  }
  ...
  // direct/copy initialization - double argument (braces)
  {
    vec4_t vec4 = vec4_t{vec2_t{1.0_r, 2.0_r}, vec2_t{3.0_r, 4.0_r}};
    CHECK_THAT(arr(1.0_r, 2.0_r, 3.0_r, 4.0_r), make_elements_sub(vec4, 4));
  }
  ...
  {
    vec4_t vec4 = vec4_t{vec2_t{1.0_r, 2.0_r}, 3.0_r, 4.0_r};
    CHECK_THAT(arr(1.0_r, 2.0_r, 3.0_r, 4.0_r), make_elements_sub(vec4, 4));
  }
...
{
  vec2_t vec2(1.0_r, 2.0_r);
  vec3_t vec3(vec2, 3.0_r);

  vec4_t vec4_a(vec2, 3.0_r, 4.0_r);
  vec4_t vec4_b(vec2, vec2);
  vec4_t vec4_c(vec3, 4.0_r);
...
TEST_CASE("const_elem_access_vec2_3_4", "[as_vec]")
{
  ...
  {
    const vec2_t vec2(15.0_r, 30.0_r);
  ...
  {
    const vec3_t vec3(2.0_r, 3.0_r, 4.0_r);
  ...
  {
    vec4_t vec4;
    vec4 = vec4_t(10.0_r, 20.0_r, 30.0_r, 40.0_r);
...
TEST_CASE("vec_make_from_arr", "[as_vec]")
{
  ...
  // generic make_from_arr vec3_t
  {
    ...
    CHECK(vec3.z == Approx(3.0_r).epsilon(g_epsilon));
  }
  ...
  // vec4_make_from_arr
  {
    ...
    CHECK(vec4.z == Approx(12.0_r).epsilon(g_epsilon));
    CHECK(vec4.w == Approx(16.0_r).epsilon(g_epsilon));
  }
}
...
{
  {
    ...
    vec4_t vec2(-10.0_r, 7.0_r, -50.0_r, -16.0_r);
...

  {
    ...
    vec4_t vec2(2.0_r, 3.0_r, 4.0_r, 5.0_r);
...
{
  {
    ...
    CHECK_THAT(
      arr(1.0_r, 0.0_r, 0.0_r), make_elements_sub(mat3::basis_x(basis), 3));
    CHECK_THAT(
      arr(0.0_r, 0.0_r, 1.0_r), make_elements_sub(mat3::basis_y(basis), 3));
    CHECK_THAT(
      arr(0.0_r, -1.0_r, 0.0_r), make_elements_sub(mat3::basis_z(basis), 3));
  }

  {
    const mat3_t basis = vec3::orthonormal_basis(vec3_t(0.0_r, -1.0_r, 0.0_r));
    CHECK_THAT(
      arr(0.0_r, -1.0_r, 0.0_r), make_elements_sub(mat3::basis_x(basis), 3));
    CHECK_THAT(
      arr(0.0_r, 0.0_r, -1.0_r), make_elements_sub(mat3::basis_y(basis), 3));
    CHECK_THAT(
      arr(1.0_r, 0.0_r, 0.0_r), make_elements_sub(mat3::basis_z(basis), 3));
  }
...

  {
    ...
    CHECK_THAT(
      arr(0.0_r, 0.0_r, 1.0_r), make_elements_sub(mat3::basis_x(basis), 3));
    CHECK_THAT(
      arr(0.0_r, -1.0_r, 0.0_r), make_elements_sub(mat3::basis_y(basis), 3));
    CHECK_THAT(
      arr(1.0_r, 0.0_r, 0.0_r), make_elements_sub(mat3::basis_z(basis), 3));
  }

  {
    ...
    CHECK_THAT(
      ...
      make_elements_sub(mat3::basis_x(basis), 3).epsilon(0.001_r));
    CHECK_THAT(
      arr(-0.707107_r, 0.707107_r, 0.000000_r),
      make_elements_sub(mat3::basis_y(basis), 3).epsilon(0.001_r));
    CHECK_THAT(
      arr(0.0_r, 0.0_r, 1.0_r), make_elements_sub(mat3::basis_z(basis), 3));
  }
}
