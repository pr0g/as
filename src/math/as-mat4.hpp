...
template<> struct Mat<real, 4, 4>
{
	...
	constexpr explicit Mat(const v4& v_0, const v4& v_1, const v4& v_2, const v4& v_3)
		: v_0(v_0), v_1(v_1), v_2(v_2), v_3(v_3) {}
	constexpr explicit Mat(const m33& mat, const v3& vec) : v_0(mat.v_0, 0.0f), v_1(mat.v_1, 0.0f), v_2(mat.v_2, 0.0f), v_3(vec, 1.0f) {}
};
